...
@NamedQueries({
    ...
    , @NamedQuery(name = "Felhasznalo.findByUser", query = "SELECT f FROM Felhasznalo f WHERE f.user = :user")
    , @NamedQuery(name = "Felhasznalo.findByPassword", query = "SELECT f FROM Felhasznalo f WHERE f.password = :password")})
public class Felhasznalo implements Serializable {
    ...
    public Felhasznalo(Integer id, String user, String password) {
        this.id = id;
        this.user = user;
